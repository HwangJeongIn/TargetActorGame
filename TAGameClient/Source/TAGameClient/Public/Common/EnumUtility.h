...
#define CONVERT_FUNCTION_DECLARATION(EnumTypeName)											  \
	...
	CONVERT_FUNCTION_DECLARATION(ConditionGameDataObjectType)
	CONVERT_FUNCTION_DECLARATION(EventGameDataObjectType)
	CONVERT_FUNCTION_DECLARATION(BuffGameDataObjectType)
	CONVERT_FUNCTION_DECLARATION(CharacterStatType)
